...
本实验未实现 `Normalized Representation` runtime、任何生产 Adapter、OCR pipeline、Atomic Information、Object、TOS 或 UI。所有真实资料始终留在本机；本目录不含真实路径、文件名、正文、图片、hash、人员、公司、项目或凭证。
